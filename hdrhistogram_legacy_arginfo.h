...
ZEND_BEGIN_ARG_INFO_EX(arginfo_class_HdrHistogram_Histogram_recordValue, 0, 0, 1)
	ZEND_ARG_INFO(0, value)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_HdrHistogram_Histogram_recordValues, 0, 0, 2)
	ZEND_ARG_INFO(0, value)
	ZEND_ARG_INFO(0, count)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_HdrHistogram_Histogram_getMin, 0, 0, 0)
ZEND_END_ARG_INFO()

#define arginfo_class_HdrHistogram_Histogram_getMax arginfo_class_HdrHistogram_Histogram_getMin

#define arginfo_class_HdrHistogram_Histogram_getCountAtValue arginfo_class_HdrHistogram_Histogram_recordValue

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_HdrHistogram_Histogram_getValueAtPercentile, 0, 0, 1)
	ZEND_ARG_INFO(0, percentile)
ZEND_END_ARG_INFO()
